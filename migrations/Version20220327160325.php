...
final class Version20220327160325 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX partner_id_order_id_unique ON `order`');
        $this->addSql('DROP INDEX partner_id ON `order`');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE INDEX order_id ON `order` (order_id(768))');
        $this->addSql('CREATE UNIQUE INDEX partner_id_order_id_unique ON `order` (partner_id, order_id)');
        $this->addSql('CREATE INDEX partner_id ON `order` (partner_id)');
